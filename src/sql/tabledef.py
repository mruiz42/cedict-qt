...
class ApplicationMeta(Base):
    ...
    # ----------------------------------------------------------------------
    def __init__(self, application_version: str, database_version: str, cedict_version: str,
                 db_creation_time: datetime, cedict_creation_time: datetime,
                 entries: int, cedict_license: str, cedict_publisher: str):
        self.application_version = application_version  # TODO: Change to application_version for consistency
